...
export function resolveCreateBbox(startPointer: NormalizedPoint, currentPointer: NormalizedPoint): NormalizedBbox {
  return {
...
export function isBboxLargeEnough(bbox: NormalizedBbox, minimumSize: NormalizedMinimumSize): boolean {
