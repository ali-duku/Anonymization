...
export const APP_META: AppMeta = {
  ...
  releaseNotes: [
    ...
    },
    {
      ...
      date: "2026-04-07",
      highlights: [
        "Strengthened PDF/session identity continuity with manual PDF content-hash identity support and hardened per-PDF overlay session persistence/restore validation.",
        "Added deterministic work-safety UX: browser close/refresh now warns for unsaved-or-not-generated work, and matching PDFs with saved edits now prompt explicit Restore or Skip choices instead of silent restore.",
        "Improved editing ergonomics by enabling canonical undo/redo shortcuts in bbox editor dialog contexts (without hijacking text-field undo) and making bbox icons/corner anchors hover-driven with brief persistence after hover exits.",
      ],
    },
    {
      version: "0.7.4",
